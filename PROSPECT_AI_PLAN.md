...
[x] 47. Criar `src/app/infrastructure/supabase/repositories/lead.supabase-repository.ts` implementando LeadRepository. Usar supabase.client. Capturar erro PostgreSQL 23505 e converter em DuplicateLeadError. + spec contra Supabase local (rodar `supabase start` primeiro).
```
